...
Ticket number:<?php
$i=0;
while($i<($_SESSION['sessionvar'])){
 echo ($_SESSION['tickets'][$i]);
 echo",";
 $i=$i+1;
 }
  ?> </h5>
...
<a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo $user_data['email'];?> &su=SUBJECT&body=BODY" target="_blank" id="email">Send email</a>
